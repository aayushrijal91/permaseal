        ...
        <div class="row justify-content-center">
            <div class="col-lg-11">
                <div class="row no-gutters justify-content-between">
                    <div class="col-auto">
                        <div class="cta-card">
                            <div><?= renderImg("cta-1.png", "lib") ?></div>
                            <div class="cta-title">
                                <div>Water-Repellent<br> &amp; Easy To Clean</div>
                                <div class="sm-text">(Dropeffect®Technology)</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="cta-card">
                            <div><?= renderImg("cta-2.png", "lib") ?></div>
                            <div class="cta-title">Rapid<br> Drying</div>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="cta-card">
                            <div><?= renderImg("cta-3.png", "lib") ?></div>
                            <div class="cta-title">
                    ...
                    <div class="col-auto">
                        <div class="cta-card">
                            <div><?= renderImg("cta-4.png", "lib") ?></div>
                            <div class="cta-title">Stable &amp;<br> Uniform Colour</div>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="cta-card">
                            <div><?= renderImg("cta-5.png", "lib") ?></div>
                            <div class="cta-title">
                    ...
                    <div class="col-auto">
                        <div class="cta-card">
                            <div><?= renderImg("cta-6.png", "lib") ?></div>
                            <div class="cta-title">
    ...
    <div class="container">
        <div class="row">
            <div class="col-5">
                ...
                <div class="text-white h7 fw-800 text-uppercase pt-5">
    ...
    <div class="container">
        <div class="accordion-container">
            <div class="accordion-card">
                <div class="accordion-head active"><span class="text-primary pr-4">Q:</span>What is my interest rate?<span class="plusminus"><svg width="18" height="13" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="accordion-body" style="display: block;">
                    <span class="text-primary pr-4">A:</span>We workshop your deal with >50 lenders to find you the best rate and terms
                </div>
            </div>
            <div class="accordion-card">
                <div class="accordion-head"><span class="text-primary pr-4">Q:</span>How long does the process take?<span class="plusminus"><svg width="18" height="13" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="accordion-body">
                    <span class="text-primary pr-4">A:</span>It depends on the lender we approach however most lenders are same day
                </div>
            </div>
            <div class="accordion-card">
                <div class="accordion-head"><span class="text-primary pr-4">Q:</span>I don’t have my financials ready?<span class="plusminus"><svg width="18" height="13" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.4371 3.9577C17.5909 3.79357 17.719 3.59064 17.814 3.36051C17.909 3.13039 17.9691 2.87756 17.9908 2.61647C18.0347 2.08918 17.9197 1.56024 17.6711 1.14602C17.4224 0.731795 17.0606 0.46622 16.6651 0.407715C16.2696 0.34921 15.8729 0.502568 15.5622 0.834052L9 7.83327L2.43782 0.834051C2.12714 0.502567 1.73041 0.349209 1.33492 0.407714C0.939421 0.466219 0.577557 0.731794 0.328928 1.14602C0.0802993 1.56024 -0.0347253 2.08918 0.00915708 2.61647C0.0530375 3.14376 0.252231 3.62622 0.562918 3.9577L8.06255 11.9568C8.32858 12.2408 8.65921 12.3955 9 12.3955C9.34079 12.3955 9.67142 12.2408 9.93745 11.9568L17.4371 3.9577Z" fill="#36D4D8" />
                        </svg></span>
                </div>
                <div class="accordion-body">
                    <span class="text-primary pr-4">A:</span>That’s okay! We have access to numerous no/lo doc options with competitive rates
                </div>
            </div>
            <div class="accordion-card">
                <div class="accordion-head"><span class="text-primary pr-4">Q:</span> I haven’t borrowed money before.<span class="plusminus">
                        <svg width="18" height="13" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.4371 3.9577C17.5909 3.79357 17.719 3.59064 17.814 3.36051C17.909 3.13039 17.9691 2.87756 17.9908 2.61647C18.0347 2.08918 17.9197 1.56024 17.6711 1.14602C17.4224 0.731795 17.0606 0.46622 16.6651 0.407715C16.2696 0.34921 15.8729 0.502568 15.5622 0.834052L9 7.83327L2.43782 0.834051C2.12714 0.502567 1.73041 0.349209 1.33492 0.407714C0.939421 0.466219 0.577557 0.731794 0.328928 1.14602C0.0802993 1.56024 -0.0347253 2.08918 0.00915708 2.61647C0.0530375 3.14376 0.252231 3.62622 0.562918 3.9577L8.06255 11.9568C8.32858 12.2408 8.65921 12.3955 9 12.3955C9.34079 12.3955 9.67142 12.2408 9.93745 11.9568L17.4371 3.9577Z" fill="#36D4D8" />
                        </svg>
                    </span></div>
                <div class="accordion-body">
                    <span class="text-primary pr-4">A:</span>We’ve assisted 100s of first time borrowers and made the process seamless
                </div>
            </div>
        </div>
    </div>
