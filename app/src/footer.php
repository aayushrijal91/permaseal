<footer>
	<div class="container">
		<div class="row justify-content-center justify-content-lg-between align-items-center py-3 py-lg-5">
			<div class="col-auto">
				<div class="row no-gutters mb-3 mb-md-0 text-white justify-content-center h15">
					...
					<div class="col-auto px-2 px-md-4 px-xl-5">|</div>
					<div class="col-12 col-md-auto text-center">All Rights Reserved</div>
				</div>
			</div>
			<div class="col-auto">
