						...
						<div class="row justify-content-center justify-content-lg-between align-items-center">
							...
							<div class="col-12 col-md">
								<div class="row no-gutters align-items-center justify-content-between">
									<div class="col col-md-auto letter-spacing-1 text-primary h11 px-md-4 py-2 py-md-0 text-center">
									...
									<div class="col-6 col-md-auto py-2 py-md-0">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="row no-gutters pt-4 pt-md-5">
							<div class="col-6 col-md-5 pr-1 pr-md-4">
								<a href="#form" class="btn btn-block bordered">
									Find Out More
								</a>
							</div>
							<div class="col-6 col-md-5 pl-1 pl-md-4">
		...
		<div class="banner-bottom">
			<div class="container-fluid px-0">
				<div class="row no-gutters align-items-end">
					...
					<div class="col px-3 px-md-5 pt-5 pt-md-0">
						...
						<div class="row no-gutters pt-3 pt-md-4">
							...
							<div class="col-12 col-md-4 text-white fw-500 h13 px-md-3">
					...
					<div class="col-12 col-md-3"><?= renderImg("house.png", "lib", "w-100") ?></div>
				</div>
			</div>
		</div>
	</header>