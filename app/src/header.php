							...
							<div class="col-12 col-md">
								<div class="row no-gutters align-items-center justify-content-between">
									...
									<div class="col-auto col-md-6 col-lg-auto py-2 py-lg-0">
										<a href="" class="btn text-primary px-3 d-flex justify-content-center" target="_blank">
									...
									<div class="col-6 col-lg-auto py-2 py-lg-0">
										<a href="#form-quote" class="btn btn-block rounded-0 text-white py-3 px-md-2 px-lg-5 h7 fw-800">
											$0 CALL OUT FEE
										</a>
									</div>
									<div class="col-6 col-lg-auto py-2 py-lg-0">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="row no-gutters pt-4 pt-md-5">
							<div class="col-6 col-md-4 col-lg-5 pr-1 pr-md-2 pr-lg-4">
								<a href="#form" class="btn btn-block bordered">
									Find Out More
								</a>
							</div>
							<div class="col-6 col-md-4 col-lg-5 pl-1 pl-md-2 pl-lg-4">
		...
		<div class="banner-bottom">
			<div class="container-fluid px-0">
				<div class="row no-gutters align-items-end">
					...
					<div class="col px-3 px-md-4 px-lg-5 pt-5 pt-lg-0">
